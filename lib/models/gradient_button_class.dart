...
const btnGradient = LinearGradient(
    colors: [Colors.cyan, Color.fromRGBO(0, 29, 61, 0.5), Colors.cyan]);
...
class GradientBorderButtonContainer extends StatelessWidget {
  GradientBorderButtonContainer(
      ...
      : this.painter = GradientPainter(
            gradient: gradient != null ? gradient : btnGradient,
        ...
        child: InkWell(
            ...
            child: Container(
                padding: EdgeInsets.symmetric(
                    vertical: padding + strokeWidth,
                    horizontal: padding + strokeWidth + 15),
                child: child)));
  }
}
